"""
Django settings for SQL Learning Platform.
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('DB_NAME', 'sql_learning'),
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 20,
    # In production only return JSON. The browsable HTML UI is dev-only.
...
if not DEBUG:
    ...
    # HTTPS-only settings — enable when you have SSL/TLS configured
