...
class MongoDBExecutor(BaseExecutor):
    ...
    def _execute_operation(self, collection, operation: str, args: list,
        ...
        op_map = {
            ...
            'updateOne': lambda: (lambda r: {'matchedCount': r.matched_count,
                                             'modifiedCount': r.modified_count})(collection.update_one(*args)),
            'updateMany': lambda: (lambda r: {'matchedCount': r.matched_count,
                                              'modifiedCount': r.modified_count})(collection.update_many(*args)),
